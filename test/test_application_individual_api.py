...
from wso2_apim_publisherclient.apis.application_individual_api import ApplicationIndividualApi
...
class TestApplicationIndividualApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = wso2_apim_publisherclient.apis.application_individual_api.ApplicationIndividualApi()
