...
class SubscriptionCollectionApi(object):
    ...
    def subscriptions_get(self, api_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.subscriptions_get(api_id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.subscriptions_get_with_http_info(api_id, **kwargs)
        else:
            (data) = self.subscriptions_get_with_http_info(api_id, **kwargs)
            return data

    def subscriptions_get_with_http_info(self, api_id, **kwargs):
        """
        Get all Subscriptions
        This operation can be used to retrieve a list of subscriptions of the user associated with the provided access token. This operation is capable of  1. Retrieving all subscriptions for the user's APIs. `GET https://127.0.0.1:9443/api/am/publisher/v0.11/subscriptions`  2. Retrieving subscriptions for a specific API. `GET https://127.0.0.1:9443/api/am/publisher/v0.11/subscriptions?apiId=c43a325c-260b-4302-81cb-768eafaa3aed` 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.subscriptions_get_with_http_info(api_id, callback=callback_function)
